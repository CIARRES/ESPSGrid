...
#define XML_FILE "powerMeter.cid"
...
int main(int argc, char* argv[]) {
    if (argc != 4) {
        std::cerr << "Usage: " << argv[0] << " <pm_id> <ip> <gateway>" << std::endl;
        return 1;
    }
