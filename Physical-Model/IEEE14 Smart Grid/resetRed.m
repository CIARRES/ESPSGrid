...
aux = direccion + "CC_" + B1_L5;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B1_L4;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B2_G1 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B2_L5 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B2_L4 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B2_G3 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B3_L4 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B6_L11 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B6_L12 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B6_L13;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B6_L13_2;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B6_L10 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B6_L14 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B8_L5 ;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B8_L14;
set_param(aux, 'Value', mat2str(0));

aux = direccion + "CC_" + B8_L10;
set_param(aux, 'Value', mat2str(0));